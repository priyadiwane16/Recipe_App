    ...
    <>
      <section className="mt-2 mx-auto">
        ...
        <div className="w-full mx-auto">
          <Slider {...settings}>
            {meals.map((meal) => (
              <div key={meal.idMeal} className="p-10  flex justify-center">
                <Link to={`/recipe/${meal.idMeal}/`}>
                  <div className="relative bg-gray-900 rounded-xl shadow-xl shadow-black/50 overflow-hidden group transform transition duration-500 cursor-pointer border border-gray-800 hover:shadow-blue-600/50 mb-5">
                    ...
                    <div className="flex justify-center items-center p-4.5 ">
                      <img
                        src={meal?.strMealThumb}
                        alt=""
                        className=" rounded-xl border border-yellow-400 transition duration-500 group-hover:scale-105"
                      />
                    </div>
                  </div>
                </Link>
